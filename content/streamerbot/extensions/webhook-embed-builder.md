...
### Build Discord embeds visually. Use them everywhere in Streamer.bot.
...
> **_Quick access:_** {"Web UI"-g}(https://sorylokan.github.io/WEBWUI-Web_Interface/) • {"Docs"-s}(?p=content/streamerbot/extensions/docs/webhook-embed-builder)
...
<div class="center">
<iframe width="720" height="405" src="https://www.youtube.com/embed/HmIqm_GuOG0?si=BsTCCb250KJ_wbj0" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
</div>
...
<br>The goal is to give people full creative control over how their messages look and feel, instead of relying on generic Discord bot announcements. In that sense, WEB•UI aims to replace or at least offer an alternative to bots like Wizebot, Streamcord, MEE6, Pingcord, and similar tools.<br>
Technically, WEB•UI is a combination of:
* a **web-based interface**
* and **Streamer.bot actions**

The web interface generates a JSON payload that is stored in a **global variable** inside Streamer.bot. This payload is then used by a **custom C# script** that can either **send** or **edit** a Discord message (typically via webhooks).<br>
The idea behind creating a complete visual embed system came from a personal frustration: Streamer.bot currently provides a *"Basic Webhook"* action that only sends plain text messages. While functional, it feels very limiting when you want rich, expressive Discord embeds.<br>
...
2. Design your Discord message visually
3. Save it to Streamer.bot
4. Reuse it in any action
...
3. Method:
   ...
   * `SendOnly` – send the rich message
...
* `~globalVar~` → Streamer.bot global variables

> Variables are resolved when sending via Streamer.bot.
...
2. Drag & drop it into Streamer.bot | *(or paste the string)*

And you're done !
All you have to do now is explore the examples or create your own action!

### Requirements

**To Set and save a new payload:**
* Streamer.bot running with the WebSocket enabled
* A Discord webhook URL
* A modern browser, to acces the web UI

**To Send your Discord Embed**
* Streamer.bot running
* A saved payload in you global variables
* Have an set action that has a trigger
...
* 🌐 **Open WEB•UI**
  {"Web UI"-s}(https://sorylokan.github.io/WEBWUI-Web_Interface/)

* 📦 **Download Streamer.bot Import**
  {"Github Repo"-n}(https://github.com/Sorylokan/WEBWUI-Web_Interface/blob/main/Script/WEBWUI-import.sb)

* 🧠 **View C# Script**
  {"look at the c# script"-g}(https://github.com/Sorylokan/WEBWUI-Web_Interface/blob/main/Script/WEBWUI-Sender.cs)
